...
public class MissedSalesAdapter extends BaseRecyclerAdapter<ItemOrders, MissedSalesAdapter.ViewHolder> {
    private Context mContext;

    public MissedSalesAdapter(Context context, List<ItemOrders> list) {
        super(context, list);
        this.mContext = context;
    }

    @Override
    public void onBindViewHolder(MissedSalesAdapter.ViewHolder holder, int position) {
        holder.binData(list.get(position), position);
    }

    @Override
    public MissedSalesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.item_missed_sales, parent, false);
